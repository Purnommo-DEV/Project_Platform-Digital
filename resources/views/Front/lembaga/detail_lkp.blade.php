                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-lg-5">
                        <div class="boosting-style-one">
                            <h4 class="sub-title">{{ $lkp_detail->kategori }}</h4>
                            <p><i class="far fa-city"></i>&nbsp;&nbsp;{{ $lkp_detail->relasi_kota->kota ?? '' }}</p>
                            <h2 class="title">{{ $lkp_detail->lkp }}</h2>
                            <p>
                                {{ $lkp_detail->deskripsi }}
                            </p>
                            <ul class="shor-contact">
                                <li>
                                    @foreach ($sosmed_lkp as $sosmed)
                            ...
                            <ul class="shor-contact">
                                <li>
                                    <div class="icon" style="padding-right: 0.6rem;">
                                        ...
                                        color: #000000;"
                                            href="{{ route('HalamanDetailLKP', $lkp_detail->slug) }}">Share
                                            Link</a>
                                    </div>
                                </li>
                            </ul>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h4 class="sub-title">Klik Banner</h4>
